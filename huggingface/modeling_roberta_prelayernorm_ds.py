...
class DeepSpeedTransformerEncoderLayer(DeepSpeedTransformerLayer):
    def __init__(self, 
        ...
        cuda_config = DeepSpeedTransformerConfig(
            ...
            intermediate_size=encoder_ffn_embed_dim,
        ...
        self.layer = nn.ModuleList(
            [   
                DeepSpeedTransformerEncoderLayer(
                    ...
                    encoder_ffn_embed_dim=config.intermediate_size,
...
class RobertaClassificationHead(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.dense = nn.Linear(config.hidden_size, config.hidden_size)
        classifier_dropout = (
            config.classifier_dropout if getattr(config, "classifier_dropout", None) else config.hidden_dropout_prob
        )
        self.dropout = nn.Dropout(classifier_dropout)
